module Rack
  class Prerender
    ...
    def initialize(app, options = {})
      ...
      @extensions_to_ignore = %w[.js .css .xml .less .png .jpg .jpeg .gif .pdf .doc .txt .ico .rss .zip .mp3 .rar .exe .wmv .doc .avi .ppt .mpg .mpeg .tif .wav .mov .psd .ai .xls .mp4 .m4a .swf .dat .dmg .iso .flv .m4v .torrent]
    ...
    def should_show_prerendered_page(env)
      ...
      is_requesting_prerendered_page = true if Rack::Utils.parse_query(request.query_string).key?('_escaped_fragment_')
      ...
      is_requesting_prerendered_page
    end
